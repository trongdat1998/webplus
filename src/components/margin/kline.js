...
class Kline extends React.Component {
    ...
    this.state = {
      ...
      overrides: function (t) {
        return {
          ...
          "mainSeriesProperties.areaStyle.linecolor": t.areatop,
  ...
  changeResolition = (data) => {
    const { resolution, res, chartType, slug } = data;
    this.cancel(
      "kline_" +
  ...
  start = () => {
    ...
    // const token1_name = symbol_info.baseTokenName;;
    ...
    tvwidget = new TradingView.widget({
      ...
      //fullscreen: true,
      // toolbar_bg: this.state.theme.bg,
      // loading_screen: { backgroundColor: this.state.theme.bg },
